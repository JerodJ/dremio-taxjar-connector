...
3. Download and install the [TaxJar JDBC Driver from CData](https://www.cdata.com/drivers/taxjar/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
