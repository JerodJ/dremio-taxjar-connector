...
@SourceType(value = "TaxJarARP", label = "TaxJar",uiConfig = "taxjar-layout.json")
public class TaxJarConf extends AbstractArpConf<TaxJarConf> {
  private static final String ARP_FILENAME = "arp/implementation/taxjar-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.taxjar.TaxJarDriver";
